...
E=1e5
for h in np.arange(0.0,4.2,0.1):
    for i in range(0,30):
        # h=2
        s=0.0*np.pi
        t=2.0
    ...
    bulk_m.append((Sp1[2]+Sp2[2]+Sp3[2]+Sp4[2]+Sp5[2]+Sp6[2]+Sp7[2]+Sp8[2]+Sp9[2]+Sp10[2]+Sp11[2]+Sp12[2]+Sp13[2]+Sp14[2]+Sp15[2]+Sp16[2]).item().real)
